...
L'icona matita in tabella apre il dettaglio READ-ONLY (membri/camion/stato + storico viaggi),
non un editor di campi: non esiste un'operazione "modifica_squadra" nel backend, e il mockup
stesso mostra un modale senza pulsanti Annulla/Salva per questo caso (coerente con
GestoreSquadre.dettaglio_squadra(), gia' pensato come lettura)."""
        ...
        self._tabella = Table(
            [
                ...
                ColumnDef(
                    ...
                    width=76,
                    actions=[
                        RowAction("pencil", self._apri_modale_dettaglio, tooltip="Dettaglio"),
