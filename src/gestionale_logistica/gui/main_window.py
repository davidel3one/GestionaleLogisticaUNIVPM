...
from gestionale_logistica.logistica.gestore_logistica import ordine, viaggio
from gestionale_logistica.rendicontazione.gestore_rendicontazione import esito_consegna
from gestionale_logistica.risorse.gestore_camion import camion
from gestionale_logistica.risorse.gestore_dipendenti import dipendente
from gestionale_logistica.risorse.gestore_squadre import squadra
...
# Sezioni principali: nome voce di menu, CRUD (dai file di servizio per entita'), colonne
# mostrate in tabella, campi del form di inserimento, validazione aggiuntiva.
# Le chiavi esterne (es. composizione_id) vanno digitate a mano finche' non ci sono selettori
# collegati; la loro esistenza e' comunque garantita dal vincolo FK a livello di database.
SEZIONI = [
    (
        "Dipendenti",
        dipendente,
