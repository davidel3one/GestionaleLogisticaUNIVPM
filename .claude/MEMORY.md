...
- [Divergenze codice vs EA](knowledge/divergenze-ea.md) — 10 differenze intenzionali, checklist per quando si aggiorna il diagramma
- [Design motore di ottimizzazione](knowledge/design-ottimizzatore.md) — funzione obiettivo RF12/RF13, geocoding offline
