...
- [Divergenze codice vs EA](knowledge/divergenze-ea.md) — 18 differenze intenzionali, checklist per quando si aggiorna il diagramma
...
- RF14/RF19 (scheduler interno, verifica partenza automatica, report periodico) mergiate in `main` (PR #13) — dettagli in `knowledge/stato-e-prossimi-passi.md` e `knowledge/divergenze-ea.md` (punto 18)
