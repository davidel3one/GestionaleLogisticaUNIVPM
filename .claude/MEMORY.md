...
- [Divergenze codice vs EA](knowledge/divergenze-ea.md) — 19 differenze intenzionali, checklist per quando si aggiorna il diagramma
...
- RF14/RF19 (scheduler interno, verifica partenza automatica, report periodico) mergiate in `main` (PR #13) — dettagli in `knowledge/stato-e-prossimi-passi.md` e `knowledge/divergenze-ea.md` (punti 18-19)
- RF15-RF18 (registrazione esito, ripianificazione, prove documentali, consegne in transito) implementate su branch `feat/rendicontazione-rf15-rf18` — dettagli in `knowledge/stato-e-prossimi-passi.md` e `knowledge/divergenze-ea.md` (punto 17)
