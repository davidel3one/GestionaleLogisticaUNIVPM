...
- RF15-RF18 (registrazione esito, ripianificazione, prove documentali, consegne in transito) implementate su branch `feat/rendicontazione-rf15-rf18`, non ancora mergiate — dettagli in `knowledge/stato-e-prossimi-passi.md` e `knowledge/divergenze-ea.md` (punto 17)
